...
sealed class MyItem{
    ...
    data class Date(override val number : Int, val date: String) : MyItem()
}
...
object MyItemObject {
    ...
    private fun getReviewList(): MutableList<MyItem> {
        val dataList = mutableListOf<MyItem>()

        dataList.add(MyItem.Date(0, "7월 16일"))

        dataList.add(MyItem.Data(
            1,
            R.drawable.sample1,
            "산지 한달된 선풍기 팝니다",
        ...
        dataList.add(MyItem.Date(4, "7월 15일"))
        ...
        dataList.add(MyItem.Date(8,"7월 14일"))
